...
static void sb_create(void)
{
    ...
    lv_roller_set_selected(hue_roller, DEFAULT_HUE/30, LV_ANIM_ON);
...
static void content_create(void)
{
    ...
    lv_obj_set_width(kb, max_w - LV_DPI / 10);
    lv_obj_set_height(kb, (LV_DPI*5)/4);
    lv_kb_set_ta(kb, ta);
